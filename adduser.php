		...
		<div id="main-content"> <!-- Main Content Section with everything -->
			...
			<div class="content-box"><!-- Start Content Box -->
				...
				<div class="content-box-header">
					...
					<div class="tab-content default-tab" id="tab2" style="margin-left:30px;margin-top:20px;">
							...
							<fieldset> <!-- Set class to "column-left" or "column-right" on fieldsets to divide the form into columns -->
								...
								<p>
									<label>Name</label>
										...
										<br /><small>Enter the username</small>
								</p>
								...
								<p>
									<label>Password</label>
										...
										<br /><small>Enter password</small>
								</p>
								
								<p>
									<label>Email id</label>
									<input class="text-input medium-input datepicker" type="text" id="medium-input" name="email" required/>
									<br /><small>Enter email of user</small>
								</p>
